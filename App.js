...
const RAW = [
  ...
  { no:13,  staff:"곽민영", name:"[신고대리] 서린테크", proxy:true },
  { no:14,  staff:"곽민영", name:"[신고대리] 김현조 신고대리", proxy:true },
  // 방민혁
  { no:15,  staff:"방민혁", name:"89MM", proxy:false },
  { no:16,  staff:"방민혁", name:"포차마실", proxy:false },
  { no:17,  staff:"방민혁", name:"SH디자인", proxy:false },
  { no:18,  staff:"방민혁", name:"한촌설렁탕 가정점 (박헌진)", proxy:false },
  { no:19,  staff:"방민혁", name:"꽃술래", proxy:false },
  { no:20,  staff:"방민혁", name:"브레드앤쿡(최은주)", proxy:false },
  { no:21,  staff:"방민혁", name:"에프엔에스_최진", proxy:false },
  { no:22,  staff:"방민혁", name:"아뜰리에호수 부천", proxy:false },
  { no:23,  staff:"방민혁", name:"아뜰리에호수 분당", proxy:false },
  { no:24,  staff:"방민혁", name:"아뜰리에호수 수원인계점", proxy:false },
  { no:25,  staff:"방민혁", name:"파노 법률사무소", proxy:false },
  { no:26,  staff:"방민혁", name:"아뜰리에호수 대전", proxy:false },
  { no:27,  staff:"방민혁", name:"아뜰리에호수 송도", proxy:false },
  { no:28,  staff:"방민혁", name:"스터드", proxy:false },
  { no:29,  staff:"방민혁", name:"아뜰리에호수 대구", proxy:false },
  { no:30,  staff:"방민혁", name:"아뜰리에호수 부평", proxy:false },
  { no:31,  staff:"방민혁", name:"오롯밀(꽃술래 대표)", proxy:false },
  { no:32,  staff:"방민혁", name:"이비엠(정경호 대표)", proxy:false },
  { no:33,  staff:"방민혁", name:"봄패밀리_개인들 5명", proxy:false },
  { no:34,  staff:"방민혁", name:"메종꼬꼬", proxy:false },
  { no:35,  staff:"방민혁", name:"[신고대리] 올라운더 네일", proxy:true },
  // 구동현
  { no:36,  staff:"구동현", name:"제이널리스튜디오", proxy:false },
  { no:37,  staff:"구동현", name:"임대사업자(봄패밀리)_김지수", proxy:false },
  { no:38,  staff:"구동현", name:"임대사업자(봄패밀리)_김혜수", proxy:false },
  { no:39,  staff:"구동현", name:"클레프뮤직", proxy:false },
  { no:40,  staff:"구동현", name:"리하이로라", proxy:false },
  { no:41,  staff:"구동현", name:"구가네찹쌀탕수육(구형모)", proxy:false },
  { no:42,  staff:"구동현", name:"에스케이랩", proxy:false },
  { no:43,  staff:"구동현", name:"노벨라(이동국)", proxy:false },
  { no:44,  staff:"구동현", name:"곱창의 전설", proxy:false },
  { no:45,  staff:"구동현", name:"수유리 혼밥왕 양주광사점", proxy:false },
  { no:46,  staff:"구동현", name:"한미비자지원센터(이병기)", proxy:false },
  { no:47,  staff:"구동현", name:"미라클엔지니어링", proxy:false },
  { no:48,  staff:"구동현", name:"이우석", proxy:false },
  { no:49,  staff:"구동현", name:"강상재", proxy:false },
  { no:50,  staff:"구동현", name:"[성실] 재민연구소", proxy:false },
  { no:51,  staff:"구동현", name:"[성실] 보험조각가", proxy:false },
  { no:52,  staff:"구동현", name:"[성실] 문성곤", proxy:false },
  { no:53,  staff:"구동현", name:"문정현 선수", proxy:false },
  { no:54,  staff:"구동현", name:"김기호 종합소득세(증여)", proxy:false },
  { no:55,  staff:"구동현", name:"[신고대리] 박진아", proxy:true },
  // 박지석
  { no:56,  staff:"박지석", name:"BS컨설팅", proxy:false },
  { no:57,  staff:"박지석", name:"존앤321(윤종규)", proxy:false },
  { no:58,  staff:"박지석", name:"미태리파스타 분당아름마을점", proxy:false },
  { no:59,  staff:"박지석", name:"피어리필라테스", proxy:false },
  { no:60,  staff:"박지석", name:"무브앤발란스 근골격운동센터", proxy:false },
  { no:61,  staff:"박지석", name:"행복공간 (평택)", proxy:false },
  { no:62,  staff:"박지석", name:"행복공간 (천안)", proxy:false },
  { no:63,  staff:"박지석", name:"애플꼬마김밥 송도 닥터플러스점", proxy:false },
  { no:64,  staff:"박지석", name:"엑스바이트", proxy:false },
  { no:65,  staff:"박지석", name:"인딕슬로우", proxy:false },
  { no:66,  staff:"박지석", name:"리엔터테인먼트", proxy:false },
  { no:67,  staff:"박지석", name:"바른(조미경)", proxy:false },
  { no:68,  staff:"박지석", name:"제이제이 컨설팅", proxy:false },
  { no:69,  staff:"박지석", name:"연세탑수학과학전문학원", proxy:false },
  { no:70,  staff:"박지석", name:"[성실] 미인메디코스", proxy:false },
  { no:71,  staff:"박지석", name:"엠디김밥연구소(홍지미)", proxy:false },
  { no:72,  staff:"박지석", name:"봄패밀리(제주)", proxy:false },
  { no:73,  staff:"박지석", name:"곱창의전설", proxy:false },
  { no:74,  staff:"박지석", name:"봄패밀리(제주) (2)", proxy:false },
  { no:75,  staff:"박지석", name:"안목", proxy:false },
  { no:76,  staff:"박지석", name:"이모델클랜", proxy:false },
  { no:77,  staff:"박지석", name:"엔오", proxy:false },
  { no:78,  staff:"박지석", name:"펀카(개인사업자)", proxy:false },
  { no:79,  staff:"박지석", name:"[신고대리] 플러스씨원(플러스프로)", proxy:true },
  { no:80,  staff:"박지석", name:"[신고대리] 오케이비즈(플러스프로)", proxy:true },
  { no:81,  staff:"박지석", name:"[신고대리] 고든소프트웨어", proxy:true },
  { no:82,  staff:"박지석", name:"[신고대리] 바른소프트웨어", proxy:true },
  { no:83,  staff:"박지석", name:"[신고대리] 중앙전람(김윤정)", proxy:true },
  { no:84,  staff:"박지석", name:"[신고대리] 미켈란", proxy:true },
  { no:85,  staff:"박지석", name:"[신고대리] 중앙전람(최숙향)_부동산", proxy:true },
  { no:86,  staff:"박지석", name:"[신고대리] 삐요레(엠디김밥)", proxy:true },
  { no:87,  staff:"박지석", name:"[신고대리] 행복마케팅(박선홍)", proxy:true },
  // 임유빈
  { no:88,  staff:"임유빈", name:"램퍼스(이정윤)", proxy:false },
  { no:89,  staff:"임유빈", name:"더 비디", proxy:false },
  { no:90,  staff:"임유빈", name:"우리카정비", proxy:false },
  { no:91,  staff:"임유빈", name:"광성정보", proxy:false },
  { no:92,  staff:"임유빈", name:"레몬캔버스", proxy:false },
  { no:93,  staff:"임유빈", name:"바이앤에이", proxy:false },
  { no:94,  staff:"임유빈", name:"재원소재", proxy:false },
  { no:95,  staff:"임유빈", name:"카액세서리", proxy:false },
  { no:96,  staff:"임유빈", name:"모선미", proxy:false },
  { no:97,  staff:"임유빈", name:"케이시스템", proxy:false },
  { no:98,  staff:"임유빈", name:"데이큐", proxy:false },
  { no:99,  staff:"임유빈", name:"참좋은건강연구소", proxy:false },
  { no:100, staff:"임유빈", name:"사이버클라우드", proxy:false },
  { no:101, staff:"임유빈", name:"주원(이주원)", proxy:false },
  { no:102, staff:"임유빈", name:"공차 숭실대점(탁은지)", proxy:false },
  { no:103, staff:"임유빈", name:"보드람치킨(윤영단 대표)", proxy:false },
  { no:104, staff:"임유빈", name:"처갓집 양념치킨 청라호수공원(김영서)", proxy:false },
  { no:105, staff:"임유빈", name:"처갓집양념통닭 루원시티(김영기)", proxy:false },
  { no:106, staff:"임유빈", name:"제이비엠 영어 학원(대표 민정빈)", proxy:false },
  { no:107, staff:"임유빈", name:"케이티와이(대표 김태영)", proxy:false },
  { no:108, staff:"임유빈", name:"발리휘트니스", proxy:false },
  { no:109, staff:"임유빈", name:"[성실] 한촌설렁탕 청라점", proxy:false },
  { no:110, staff:"임유빈", name:"[성실] 한촌설렁탕 도화점", proxy:false },
  { no:111, staff:"임유빈", name:"[성실] 현풍닭칼국수(김혜진)", proxy:false },
  { no:112, staff:"임유빈", name:"[성실] 한촌설렁탕 영천점(권용태대표)", proxy:false },
  { no:113, staff:"임유빈", name:"[신고대리] 와이앤솔루션", proxy:true },
  { no:114, staff:"임유빈", name:"[신고대리] 발리&스쿼시(폐업25.08.22)(간이)", proxy:true },
  { no:115, staff:"임유빈", name:"[신고대리] 신현준 대표 (대그듀드, 인플루언컴퍼니,티엔샤)", proxy:true },
  { no:116, staff:"임유빈", name:"[신고대리] 윤혜현 대표_코아루센트럴시티 A906호", proxy:true },
  { no:117, staff:"임유빈", name:"[신고대리] 윤혜현 대표_코아루센트럴시티 B1010호", proxy:true },
  // 안성은
  { no:118, staff:"안성은", name:"김영미 임대사업자(와이엠케이)", proxy:false },
  { no:119, staff:"안성은", name:"이금향-마장동 (김영미대표 모친)", proxy:false },
  { no:120, staff:"안성은", name:"케이컴(성실)", proxy:false },
  { no:121, staff:"안성은", name:"당근보험(강신우)", proxy:false },
  { no:122, staff:"안성은", name:"마라섬 의정부(컴포즈커피)", proxy:false },
  { no:123, staff:"안성은", name:"나원", proxy:false },
  { no:124, staff:"안성은", name:"도림천 도룡뇽", proxy:false },
  { no:125, staff:"안성은", name:"피에프엘이", proxy:false },
  { no:126, staff:"안성은", name:"태희상사", proxy:false },
  { no:127, staff:"안성은", name:"호루라기", proxy:false },
  { no:128, staff:"안성은", name:"제이에스이(하정국)", proxy:false },
  { no:129, staff:"안성은", name:"제이에스이 공동사업자(하수빈/하은빈) (1)", proxy:false },
  { no:130, staff:"안성은", name:"제이에스이 공동사업자(하수빈/하은빈) (2)", proxy:false },
  { no:131, staff:"안성은", name:"내몸에필라테스(김선영)", proxy:false },
  { no:132, staff:"안성은", name:"틈새가게 (4개) / 황신혜", proxy:false },
  { no:133, staff:"안성은", name:"샾아이스크림(수택점) (3개) / 오병수", proxy:false },
  { no:134, staff:"안성은", name:"[성실] 홍스타츠", proxy:false },
  { no:135, staff:"안성은", name:"세일즈마스터코리아", proxy:false },
  { no:136, staff:"안성은", name:"파란만잔 영등포구청점", proxy:false },
  { no:137, staff:"안성은", name:"역전할머니 분당오리역점", proxy:false },
  { no:138, staff:"안성은", name:"컴포즈컴피 (폐업)", proxy:false },
  { no:139, staff:"안성은", name:"당근보험(강신우) (2)", proxy:false },
  // 기타
  { no:140, staff:"기타", name:"보험설계사 (김유진)", proxy:false },
  { no:141, staff:"기타", name:"보험설계사 (양미란)", proxy:false },
];
