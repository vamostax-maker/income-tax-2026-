...
const INCOME_TYPES = ["사업소득", "근로소득", "임대소득", "기타소득", "금융소득", "양도소득", "사업+근로", "사업+근로+기타", "사업+근로+연금", "사업+근로+퇴직", "사업+연금", "사업+기타", "사업+근로+기타", "이자+배당+사업+근로", "이자+배당+사업", "사업(복식부기)", "사업(간편장부)", "모두채움", "성실신고대상자"];

const PALETTE = ["#3b82f6","#10b981","#f59e0b","#ef4444","#8b5cf6","#06b6d4","#f97316","#ec4899"];

// 새 거래처 데이터 (no, staff, name, proxy, revenue, incomeType)
const RAW = [
  // 곽민영
  { no:1,  staff:"곽민영", name:"돌리앗",                                  proxy:false, revenue:267138965,   incomeType:"사업소득" },
  { no:2,  staff:"곽민영", name:"힌지큐브",                                 proxy:false, revenue:77701600,    incomeType:"사업+근로" },
  { no:3,  staff:"곽민영", name:"심가당",                                   proxy:false, revenue:224732061,   incomeType:"사업+근로" },
  { no:4,  staff:"곽민영", name:"아이제이네일",                              proxy:false, revenue:81669806,    incomeType:"사업소득" },
  { no:5,  staff:"곽민영", name:"링커",                                     proxy:false, revenue:71940752,    incomeType:"사업+근로" },
  { no:6,  staff:"곽민영", name:"아이스드림 퇴촌 (서동진)",                  proxy:false, revenue:99918491,    incomeType:"사업+근로" },
  { no:7,  staff:"곽민영", name:"아이스드림 (서수현)",                       proxy:false, revenue:130202203,   incomeType:"사업+근로" },
  { no:8,  staff:"곽민영", name:"샵아이스 (권효영)",                         proxy:false, revenue:185825690,   incomeType:"사업+근로" },
  { no:9,  staff:"곽민영", name:"건강운동과학연구소(지무엽)",                 proxy:false, revenue:153381670,   incomeType:"사업+근로" },
  { no:10, staff:"곽민영", name:"아뜰리에호수 안양",                         proxy:false, revenue:221252353,   incomeType:"사업소득" },
  { no:11, staff:"곽민영", name:"[신고대리] 샤인소프트_신광배",              proxy:true,  revenue:0,           incomeType:"사업소득" },
  { no:12, staff:"곽민영", name:"[신고대리] 샤인소프트_신미나",              proxy:true,  revenue:41816213,    incomeType:"사업+근로" },
  { no:13, staff:"곽민영", name:"[신고대리] 샤인소프트_정윤희(신미나어머니)", proxy:true,  revenue:8111198,     incomeType:"사업+연금" },
  { no:14, staff:"곽민영", name:"[신고대리] 서린테크",                       proxy:true,  revenue:67810000,    incomeType:"사업+근로" },
  { no:15, staff:"곽민영", name:"[신고대리] 김현조 신고대리",                proxy:true,  revenue:30631199,    incomeType:"사업+근로+기타" },
  { no:16, staff:"곽민영", name:"[신고대리] 중앙(심규정_심가당 신고대리)",   proxy:true,  revenue:56808565,    incomeType:"사업소득" },
  { no:17, staff:"곽민영", name:"[신고대리] 베이스라인_정경호대표",          proxy:true,  revenue:80001200,    incomeType:"사업+근로" },
  { no:18, staff:"곽민영", name:"[신고대리] 스포니스약수 김태우점장",        proxy:true,  revenue:103759588,   incomeType:"사업+근로" },
  { no:19, staff:"곽민영", name:"[신고대리] 스포니스반포 정진욱점장",        proxy:true,  revenue:78742192,    incomeType:"사업소득" },
  // 방민혁
  { no:20, staff:"방민혁", name:"89MM",                                     proxy:false, revenue:521523746,   incomeType:"사업(복식부기)" },
  { no:21, staff:"방민혁", name:"포차마실",                                  proxy:false, revenue:292517980,   incomeType:"사업(복식부기)" },
  { no:22, staff:"방민혁", name:"SH디자인",                                  proxy:false, revenue:64436731,    incomeType:"사업(복식부기)" },
  { no:23, staff:"방민혁", name:"한촌설렁탕 가정점 (박헌진)",                proxy:false, revenue:474438472,   incomeType:"사업(복식부기)" },
  { no:24, staff:"방민혁", name:"꽃술래",                                    proxy:false, revenue:363813055,   incomeType:"사업(복식부기)" },
  { no:25, staff:"방민혁", name:"오롯밀(꽃술래 대표)",                       proxy:false, revenue:70579993,    incomeType:"사업소득" },
  { no:26, staff:"방민혁", name:"브레드앤쿡(최은주)",                        proxy:false, revenue:297036009,   incomeType:"사업(복식부기)" },
  { no:27, staff:"방민혁", name:"에프엔에스_최진",                           proxy:false, revenue:35151021,    incomeType:"사업+근로" },
  { no:28, staff:"방민혁", name:"에프엔에스_최진욱",                         proxy:false, revenue:21486690,    incomeType:"사업+근로" },
  { no:29, staff:"방민혁", name:"아뜰리에호수 부천",                         proxy:false, revenue:298805807,   incomeType:"사업+근로" },
  { no:30, staff:"방민혁", name:"아뜰리에호수 분당",                         proxy:false, revenue:326432828,   incomeType:"사업+근로" },
  { no:31, staff:"방민혁", name:"아뜰리에호수 수원인계점",                   proxy:false, revenue:360828549,   incomeType:"사업+근로" },
  { no:32, staff:"방민혁", name:"파노 법률사무소",                           proxy:false, revenue:216362824,   incomeType:"사업(복식부기)" },
  { no:33, staff:"방민혁", name:"아뜰리에호수 대전",                         proxy:false, revenue:263512596,   incomeType:"사업+근로" },
  { no:34, staff:"방민혁", name:"아뜰리에호수 송도",                         proxy:false, revenue:283708227,   incomeType:"사업소득" },
  { no:35, staff:"방민혁", name:"스터드",                                    proxy:false, revenue:109302999,   incomeType:"사업소득" },
  { no:36, staff:"방민혁", name:"아뜰리에호수 대구",                         proxy:false, revenue:151703732,   incomeType:"사업소득" },
  { no:37, staff:"방민혁", name:"아뜰리에호수 부평",                         proxy:false, revenue:45661847,    incomeType:"사업소득" },
  { no:38, staff:"방민혁", name:"메종꼬꼬",                                  proxy:false, revenue:82671910,    incomeType:"사업소득" },
  { no:39, staff:"방민혁", name:"[신고대리] 올라운더 네일",                  proxy:true,  revenue:64694228,    incomeType:"사업소득" },
  // 구동현
  { no:40, staff:"구동현", name:"임대사업자(봄패밀리)_김지수",               proxy:false, revenue:91114229,    incomeType:"사업소득" },
  { no:41, staff:"구동현", name:"임대사업자(봄패밀리)_김혜수",               proxy:false, revenue:81473616,    incomeType:"사업+근로" },
  { no:42, staff:"구동현", name:"클레프뮤직",                                proxy:false, revenue:19581000,    incomeType:"사업소득" },
  { no:43, staff:"구동현", name:"리하이로라",                                proxy:false, revenue:1534000,     incomeType:"모두채움" },
  { no:44, staff:"구동현", name:"구가네찹쌀탕수육(구형모)",                  proxy:false, revenue:192880610,   incomeType:"사업소득" },
  { no:45, staff:"구동현", name:"에스케이랩",                                proxy:false, revenue:260220939,   incomeType:"사업소득" },
  { no:46, staff:"구동현", name:"노벨라(이동국)",                            proxy:false, revenue:25123577,    incomeType:"사업소득" },
  { no:47, staff:"구동현", name:"곱창의 전설",                               proxy:false, revenue:186882586,   incomeType:"사업소득" },
  { no:48, staff:"구동현", name:"수유리 혼밥왕 양주광사점",                  proxy:false, revenue:0,           incomeType:"사업소득" },
  { no:49, staff:"구동현", name:"한미비자지원센터(이병기)",                  proxy:false, revenue:49634198,    incomeType:"사업소득" },
  { no:50, staff:"구동현", name:"미라클엔지니어링",                          proxy:false, revenue:684091853,   incomeType:"사업소득" },
  { no:51, staff:"구동현", name:"이우석",                                    proxy:false, revenue:173101348,   incomeType:"사업소득" },
  { no:52, staff:"구동현", name:"[성실] 강상재",                             proxy:false, revenue:763458560,   incomeType:"사업소득" },
  { no:53, staff:"구동현", name:"[성실] 재민연구소",                         proxy:false, revenue:660553861,   incomeType:"사업소득" },
  { no:54, staff:"구동현", name:"[성실] 보험조각가",                         proxy:false, revenue:1305146438,  incomeType:"사업소득" },
  { no:55, staff:"구동현", name:"[성실] 문성곤",                             proxy:false, revenue:688117274,   incomeType:"사업소득" },
  { no:56, staff:"구동현", name:"문정현 선수",                               proxy:false, revenue:155499777,   incomeType:"사업소득" },
  { no:57, staff:"구동현", name:"[신고대리] 박진아",                         proxy:true,  revenue:169524051,   incomeType:"사업소득" },
  // 박지석
  { no:58, staff:"박지석", name:"BS컨설팅",                                  proxy:false, revenue:53214105,    incomeType:"사업소득" },
  { no:59, staff:"박지석", name:"존앤321(윤종규)",                           proxy:false, revenue:47946608,    incomeType:"사업+근로" },
  { no:60, staff:"박지석", name:"미태리파스타 분당아름마을점",               proxy:false, revenue:365446404,   incomeType:"사업소득" },
  { no:61, staff:"박지석", name:"피어리필라테스",                            proxy:false, revenue:279395439,   incomeType:"사업소득" },
  { no:62, staff:"박지석", name:"무브앤발란스 근골격운동센터",               proxy:false, revenue:183577882,   incomeType:"사업소득" },
  { no:63, staff:"박지석", name:"행복공간 (평택)",                           proxy:false, revenue:162246466,   incomeType:"사업소득" },
  { no:64, staff:"박지석", name:"행복공간 (천안)",                           proxy:false, revenue:0,           incomeType:"사업소득" },
  { no:65, staff:"박지석", name:"애플꼬마김밥 송도 닥터플러스점",           proxy:false, revenue:330943609,   incomeType:"사업소득" },
  { no:66, staff:"박지석", name:"엑스바이트",                                proxy:false, revenue:232885211,   incomeType:"사업소득" },
  { no:67, staff:"박지석", name:"인딕슬로우",                                proxy:false, revenue:342062786,   incomeType:"사업+근로" },
  { no:68, staff:"박지석", name:"리엔터테인먼트",                            proxy:false, revenue:153133816,   incomeType:"사업소득" },
  { no:69, staff:"박지석", name:"바른(조미경)",                              proxy:false, revenue:332865740,   incomeType:"사업+연금" },
  { no:70, staff:"박지석", name:"제이제이 컨설팅",                           proxy:false, revenue:70355999,    incomeType:"사업+근로" },
  { no:71, staff:"박지석", name:"연세탑수학과학전문학원",                    proxy:false, revenue:425340310,   incomeType:"사업소득" },
  { no:72, staff:"박지석", name:"[성실] 미인메디코스",                       proxy:false, revenue:915376659,   incomeType:"사업소득" },
  { no:73, staff:"박지석", name:"엠디김밥연구소(홍지미)",                    proxy:false, revenue:51649543,    incomeType:"사업소득" },
  { no:74, staff:"박지석", name:"봄패밀리(제주)",                            proxy:false, revenue:358974545,   incomeType:"사업+근로+연금" },
  ...
  { no:84, staff:"박지석", name:"[신고대리] 바른소프트웨어_무브앤발란스",    proxy:true,  revenue:0,           incomeType:"사업소득" },
  { no:85, staff:"박지석", name:"[신고대리] 중앙전람(김윤정)",               proxy:true,  revenue:9840440,     incomeType:"사업+근로+기타" },
  { no:86, staff:"박지석", name:"[신고대리] 미켈란",                         proxy:true,  revenue:106800000,   incomeType:"사업+근로+연금" },
  { no:87, staff:"박지석", name:"[신고대리] 중앙전람(최숙향)_부동산",        proxy:true,  revenue:0,           incomeType:"사업소득" },
  { no:88, staff:"박지석", name:"[신고대리] 삐요레(엠디김밥)",               proxy:true,  revenue:0,           incomeType:"사업소득" },
  { no:89, staff:"박지석", name:"[신고대리] 행복마케팅(박선홍)",             proxy:true,  revenue:27544629,    incomeType:"사업+근로+퇴직" },
  // 임유빈
  { no:90,  staff:"임유빈", name:"램퍼스(이정윤)",                           proxy:false, revenue:298200907,   incomeType:"사업(복식부기)" },
  { no:91,  staff:"임유빈", name:"더 비디",                                  proxy:false, revenue:276321677,   incomeType:"사업소득" },
  { no:92,  staff:"임유빈", name:"우리카정비",                               proxy:false, revenue:463295264,   incomeType:"사업(복식부기)" },
  { no:93,  staff:"임유빈", name:"광성정보",                                 proxy:false, revenue:60204400,    incomeType:"사업소득" },
  { no:94,  staff:"임유빈", name:"레몬캔버스",                               proxy:false, revenue:15486894,    incomeType:"사업(복식부기)" },
  { no:95,  staff:"임유빈", name:"바이앤에이",                               proxy:false, revenue:244168918,   incomeType:"사업(복식부기)" },
  { no:96,  staff:"임유빈", name:"재원소재",                                 proxy:false, revenue:34802400,    incomeType:"사업소득" },
  { no:97,  staff:"임유빈", name:"카액세서리",                               proxy:false, revenue:77548756,    incomeType:"사업소득" },
  { no:98,  staff:"임유빈", name:"모선미",                                   proxy:false, revenue:4811776,     incomeType:"사업(복식부기)" },
  { no:99,  staff:"임유빈", name:"케이시스템",                               proxy:false, revenue:81816599,    incomeType:"사업(복식부기)" },
  { no:100, staff:"임유빈", name:"데이큐",                                   proxy:false, revenue:663794347,   incomeType:"사업소득" },
  { no:101, staff:"임유빈", name:"참좋은건강연구소",                         proxy:false, revenue:0,           incomeType:"성실신고대상자" },
  { no:102, staff:"임유빈", name:"사이버클라우드",                           proxy:false, revenue:101928020,   incomeType:"사업(복식부기)" },
  { no:103, staff:"임유빈", name:"주원(이주원)",                             proxy:false, revenue:140067564,   incomeType:"사업(복식부기)" },
  ...
  { no:111, staff:"임유빈", name:"발리휘트니스",                             proxy:false, revenue:56957669,    incomeType:"사업(복식부기)" },
  { no:112, staff:"임유빈", name:"[성실] 한촌설렁탕 청라점",                 proxy:false, revenue:933811752,   incomeType:"성실신고대상자" },
  { no:113, staff:"임유빈", name:"[성실] 한촌설렁탕 도화점",                 proxy:false, revenue:802678813,   incomeType:"사업소득" },
  { no:114, staff:"임유빈", name:"[성실] 현풍닭칼국수(김혜진)",              proxy:false, revenue:871490163,   incomeType:"성실신고대상자" },
  { no:115, staff:"임유빈", name:"[성실] 한촌설렁탕 영천점(권소라 대표)",   proxy:false, revenue:811352926,   incomeType:"성실신고대상자" },
  { no:116, staff:"임유빈", name:"[신고대리] 와이앤솔루션 (폐업)",           proxy:true,  revenue:18307920,    incomeType:"모두채움" },
  { no:117, staff:"임유빈", name:"[신고대리] 발리&스쿼시(폐업25.08.22)(간이)", proxy:true, revenue:18527727,  incomeType:"사업소득" },
  { no:118, staff:"임유빈", name:"[신고대리] 대그듀드_신현준",               proxy:true,  revenue:0,           incomeType:"사업소득" },
  { no:119, staff:"임유빈", name:"[신고대리] 티엔샤_신현준",                 proxy:true,  revenue:75435342,    incomeType:"사업소득" },
  { no:120, staff:"임유빈", name:"[신고대리] 윤혜현 대표_코아루센트럴시티 A906호", proxy:true, revenue:0,     incomeType:"사업소득" },
  { no:121, staff:"임유빈", name:"[신고대리] 윤혜현 대표_코아루센트럴시티 B1010호", proxy:true, revenue:0,    incomeType:"사업소득" },
  { no:122, staff:"임유빈", name:"[신고대리] 이승복대표 임대",               proxy:true,  revenue:0,           incomeType:"임대소득" },
  { no:123, staff:"임유빈", name:"프리스키_김경현",                          proxy:false, revenue:12810491,    incomeType:"모두채움" },
  { no:124, staff:"임유빈", name:"이로운비즈파트너_양성훈",                  proxy:false, revenue:0,           incomeType:"사업소득" },
  // 안성은
  { no:125, staff:"안성은", name:"김영미 임대사업자(와이엠케이)",            proxy:false, revenue:20953806,    incomeType:"이자+배당+사업+근로" },
  { no:126, staff:"안성은", name:"이금향-마장동 (김영미대표 모친)",          proxy:false, revenue:102152836,   incomeType:"사업+근로" },
  { no:127, staff:"안성은", name:"케이컴(성실)",                             proxy:false, revenue:2496546886,  incomeType:"사업소득" },
  { no:128, staff:"안성은", name:"당근보험(강신우)",                         proxy:false, revenue:313548600,   incomeType:"사업소득" },
  { no:129, staff:"안성은", name:"마라섬 의정부(컴포즈커피)",                proxy:false, revenue:654241350,   incomeType:"사업소득" },
  { no:130, staff:"안성은", name:"나원",                                     proxy:false, revenue:47041351,    incomeType:"사업소득" },
  { no:131, staff:"안성은", name:"도림천 도룡뇽",                            proxy:false, revenue:69019436,    incomeType:"사업+근로" },
  { no:132, staff:"안성은", name:"피에프엘이",                               proxy:false, revenue:19626911,    incomeType:"사업+근로" },
  { no:133, staff:"안성은", name:"태희상사",                                 proxy:false, revenue:579019820,   incomeType:"사업소득" },
  { no:134, staff:"안성은", name:"호루라기",                                 proxy:false, revenue:63463980,    incomeType:"사업소득" },
  { no:135, staff:"안성은", name:"제이에스이(하정국)",                       proxy:false, revenue:63490920,    incomeType:"사업소득" },
  { no:136, staff:"안성은", name:"제이에스이 공동사업자(하수빈/하은빈) (1)", proxy:false, revenue:19125462,    incomeType:"이자+배당+사업" },
  { no:137, staff:"안성은", name:"제이에스이 공동사업자(하수빈/하은빈) (2)", proxy:false, revenue:19725462,    incomeType:"이자+배당+사업" },
  { no:138, staff:"안성은", name:"내몸에필라테스(김선영)",                   proxy:false, revenue:121459295,   incomeType:"사업소득" },
  { no:139, staff:"안성은", name:"틈새가게 (4개) / 황신혜",                  proxy:false, revenue:270820541,   incomeType:"사업소득" },
  { no:140, staff:"안성은", name:"샾아이스크림(수택점) (3개) / 오병수",      proxy:false, revenue:267225275,   incomeType:"사업+근로" },
  { no:141, staff:"안성은", name:"[성실] 홍스타츠",                          proxy:false, revenue:2224647480,  incomeType:"사업소득" },
  { no:142, staff:"안성은", name:"세일즈마스터코리아",                       proxy:false, revenue:310749987,   incomeType:"사업+근로" },
  { no:143, staff:"안성은", name:"파란만잔 영등포구청점",                    proxy:false, revenue:79915342,    incomeType:"사업+근로" },
  { no:144, staff:"안성은", name:"역전할머니 분당오리역점",                  proxy:false, revenue:369575051,   incomeType:"사업소득" },
  { no:145, staff:"안성은", name:"컴포즈컴피 (폐업)",                        proxy:false, revenue:0,           incomeType:"사업소득" },
  { no:146, staff:"안성은", name:"용컴파니",                                 proxy:false, revenue:107546441,   incomeType:"사업소득" },
  { no:147, staff:"안성은", name:"화락바베큐치킨 망원역점 (1)",              proxy:false, revenue:14273856,    incomeType:"사업+근로" },
  { no:148, staff:"안성은", name:"화락바베큐치킨 망원역점 (2)",              proxy:false, revenue:14256329,    incomeType:"사업+근로" },
  { no:149, staff:"안성은", name:"줌인인더스트리",                           proxy:false, revenue:52849720,    incomeType:"사업+근로" },
];
  ...
  useEffect(() => {
    ...
    getDocs(colRef).then(snap => {
      if (snap.empty) {
        BASE_CLIENTS.forEach(c => {
          setDoc(doc(db, "income_clients", c.id), {
            stage: c.stage,
            memo: c.memo,
            revenue: c.revenue,
    ...
    const unsub = onSnapshot(colRef, snap => {
      ...
      setClients(BASE_CLIENTS.map(c => ({
        ...
        revenue: dbData[c.id]?.revenue ?? c.revenue,
        incomeType: dbData[c.id]?.incomeType || c.incomeType,
      })));
      setLoading(false);
    });
    return () => unsub();
                  ...
                  return (
                    <tr key={c.id} onClick={() => openDetail(c)}
                      ...
                      <td style={{ padding: "11px 12px", fontSize: 13, fontWeight: 600, color: "#111827", maxWidth: 200 }}>
                        ...
                        {c.name.replace(/^\[신고대리\] /, "").replace(/^\[성실\] /, "")}
                        {c.name.startsWith("[성실]") && <span style={{ fontSize: 10, background: "#fce7f3", color: "#9d174d", borderRadius: 4, padding: "1px 5px", marginLeft: 4, fontWeight: 700 }}>성실</span>}
                      </td>
        ...
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 100 }}
          ...
          <div style={{ background: "#fff", borderRadius: 16, padding: 28, width: 520, boxShadow: "0 20px 60px rgba(0,0,0,0.3)", maxHeight: "90vh", overflowY: "auto" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
              ...
              {selected.name.startsWith("[성실]") && <span style={{ background: "#fce7f3", color: "#9d174d", borderRadius: 6, padding: "2px 8px", fontSize: 12, fontWeight: 800 }}>성실신고</span>}
              <span style={{ fontSize: 11, color: "#9ca3af" }}>No. {selected.no}</span>
            </div>
            <h2 style={{ margin: "0 0 4px", fontSize: 17, fontWeight: 800, color: "#111827" }}>{selected.name.replace(/^\[신고대리\] /, "").replace(/^\[성실\] /, "")}</h2>
